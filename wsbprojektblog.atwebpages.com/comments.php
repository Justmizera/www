...
$DATABASE_HOST = 'fdb34.awardspace.net';
$DATABASE_USER = '4016277_justyna';
$DATABASE_PASS = 'Projekt123!';
$DATABASE_NAME = '4016277_justyna';
try {
...
function show_write_comment_form($parent_id = -1) {
    ...
    <div class="write_comment" data-comment-id="' . $parent_id . '">
        <form>
            ...
            <textarea name="content" placeholder="Tutaj wpisz swój komentarz..." required></textarea>
...
if (isset($_GET['page_id'])) {
    ...
    if (isset($_POST['name'], $_POST['content'])) {
        ...
        exit('Twój komentarz został dodany!');
    }
...
<div class="comment_header">
    <span class="total"><?=$comments_info['total_comments']?> komentarzy</span>
    <a href="#" class="write_comment_btn" data-comment-id="-1">Dodaj komentarz</a>
</div>
